...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $identifiant   = $_POST['email']; // peut être email ou téléphone
...
<head>
    <meta charset="utf-8">
    <title>Reserve&Play - Se connecter</title>
    ...
    <style>
        ...
        /* Ajoute ce style dans le <style> de login.php ou dans css/style.css */
        .creer-compte-link {
            display: block;
            width: 100%;
            max-width: 350px;
...
<?php endif; ?>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-2 text-dark mb-4 animated slideInDown">Se connecter</h1>
        </div>
    </div>
    <!-- Page Header End -->
...
<form method="POST" id="loginForm">
    ...
    <?php if ($login_error): ?>
        <div id="phpLoginError" style="color:red; margin-top:10px;">Identifiant ou mot de passe incorrect.</div>
    <?php endif; ?><br>
    <button type="submit">Connexion</button>
   <div style="max-width:350px;margin:0 auto 20px auto;text-align:center;">
    <span>Pas encore inscrit ? </span>
    <a href="register.php" style="color:#198754;font-weight:bold;text-decoration:underline;">Créer un compte</a>
</div>
</form>
    <!-- Copyright Start -->
    ...
    document.getElementById('loginForm').addEventListener('submit', function(e) {
        var identifiant = document.getElementById('email').value.trim();
        var mdp = document.getElementById('mot_de_passe').value.trim();
        var errorDiv = document.getElementById('loginError');
        var phpErrorDiv = document.getElementById('phpLoginError');
        ...
        if (!emailRegex.test(identifiant) && !telRegex.test(identifiant)) {
            errorDiv.textContent = "Veuillez entrer un email ou un numéro de téléphone valide.";
            errorDiv.style.display = 'block';
            e.preventDefault();
            return false;
        }
        // Pas d'erreur, le formulaire peut être soumis
    });
    </script>
</body>
